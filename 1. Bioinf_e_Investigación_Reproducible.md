...
## Biología + computadoras:

* **Biología Computacional**: estudio de la biología utilizando cómputo. 
    * Utilizar las herramientas hechas por alguien más para contestar tus preguntas.

* **Bioinformática**: creación de herramientas (programación) para solucionar problemas con datos biológicos. 
...
Aunque la Biología Computacional y la Bioinformática no son lo mismo, tienen mucho en común y se apreden juntas. De aquí en adelante nos referiremos a análisis bioinformáticos.
...
**Investigación reproducible** es poder repetir y obtener los mismos resultados de un trabajo. Para esto es necesario **que el producto de la investigación incluya**:

* Artículo científico (o tesis bla bla bla bla)
* Descripción de materiales y métodos
* Datos utilizados (No. Accesión, links, etc) 
* Código de cómputo
* Versión del software utilizado (porque?)
* Cualquier otra información necesaria para repetir los experimentos y análisis (por ejemplo?)
...
* Por lo tanto:
   - Software especializado (pero cual?) 
   - Resultados pueden variar dependiendo de los parámetros utilizados
